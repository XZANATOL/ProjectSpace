/*
    Book Store System
    =================
By: Abdelrahman Walied & Amr Hatem
Num:        64         &                77
Section:              1E5
*/
#include <stdio.h>
...
/*
tail pointer is used to keep track of the last node added instead of looping through the whole linked list beginning from
the head pointer every time we need to access the last node.
*/

int nob=0; //Number of books - variable is used for ID assigning

//Functions Declarations
void add_book(); //To Add a book
